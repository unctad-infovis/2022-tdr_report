...
function Video() {
  ...
  useEffect(() => {
    ...
    mp4Ref.current.src = (window.location.href.includes('unctad') ? 'https://storage.unctad.org/2022-tdr_report/' : './') + ((videoRef.current.offsetWidth < 768) ? 'assets/vid/2022-tdr_report_banner_animation_11.mp4' : 'assets/vid/2022-tdr_report_banner_animation_169.mp4');
    webmRef.current.src = (window.location.href.includes('unctad') ? 'https://storage.unctad.org/2022-tdr_report/' : './') + ((videoRef.current.offsetWidth < 768) ? 'assets/vid/2022-tdr_report_banner_animation_11.webm' : 'assets/vid/2022-tdr_report_banner_animation_169.webm');
